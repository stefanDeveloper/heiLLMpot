...
push-honeybot:
	@echo "Building and pushing honeybot for linux/amd64 to match AWS instances..."
	docker buildx build --platform linux/amd64 -t dockerphil1234/honeybot:latest --push ./honeybot
